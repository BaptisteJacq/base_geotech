...
CREATE OR REPLACE FORCE EDITIONABLE VIEW "G_GEO"."V_GEOTECH_VISUALISATION_SITE_ETUDE" ("OBJECTID", "ID_SITE", "DESCRIPTION_ETUDE", "ADRESSE_SITE", "INSEE_SITE", "X_EPSG2154", "Y_EPSG2154", "REFERENCE_INTERNE_ETUDE", "TYPE_ETUDE_LONG", "TYPE_ETUDE_COURT", "DATE_DEBUT_ETUDE", "DATE_FIN_ETUDE", "NOM_BUREAU_ETUDE", "GEOM", 
    ...
    WITH
        C_1 AS(
            ...
            FROM
                ...
                INNER JOIN G_GEO.TA_GEOTECH_ETUDE c ON c.fid_site = a.objectid
