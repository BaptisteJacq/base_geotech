...
COMMENT ON COLUMN G_GEO.TA_GEOTECH_ETUDE.FID_SITE IS 'Clé étrangère vers la table TA_GEOTECH_SITE permettant d''affecter un site à une étude.';
...
CREATE INDEX TA_GEOTECH_ETUDE_FID_SITE_IDX ON G_GEO.TA_GEOTECH_ETUDE("FID_SITE")
    TABLESPACE G_ADT_INDX;
